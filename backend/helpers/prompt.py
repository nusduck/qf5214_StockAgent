...
## 10. 目标价预测
基于PE估值法，预测未来三年(2025-2027)的目标价：
 1) 分析合理PE倍数：
   - 请结合公司历史PE水平与同行业可比公司PE范围
   - 给出未来各年度的合理PE估值区间
 2) 预测归母净利：
   - 基于历史财务数据和行业趋势
   - 分析公司未来成长增速
   - 预测2025-2027年的营收和归母净利润
 3) 计算目标价：
   - 按照"PE × 归母净利润 ÷ 总股本"计算各年度目标价
   - 当前股价为[当前价格]元，历史波动区间为[最低价]-[最高价]元

 请按以下格式输出结果：
 - 先用1-2句话简要说明估值逻辑和主要考虑因素
 - 3个月目标价：预估目标价约XX元，可能波动区间XX元~XX元
 - 6个月目标价：预期在公司业绩逐步兑现与估值修复推动下，目标价有望达到XX元左右，关键驱动因素包括季度业绩数据改善及XX等
 - 12个月目标价：中长期看，在全球新能源发展和公司战略实施的推动下，目标价预测约XX元，长期价值主要依赖于XX
 - 关键催化剂时间表：关注下一财季业绩预告、国家政策调整及XX数据，这些都可能在未来3-6个月内对股价形成重要催化作用。
 - 在最后增加一行：预计25/26/27年归母净利XX/XX/XX亿元，结合同行可比公司，给予PE XX/XX/XX倍，对应目标价XX/XX/XX元。

 注意：保持预测的合理性，不要超出历史最高价的50%，除非有极强的业绩支撑证据。目标价应基于实际财务数据和市场表现。PE倍数合理递减，考虑到市场波动和公司成长性。请确保所有数据准确无误，并在必要时注明数据来源。
